...
<jsp:include page="UsernMenu.jsp"></jsp:include>
	<form onsubmit="return validateForm()" action="./FeeAction" method="post" name="register" >
		...
		<center>
			<b><h2>
				...
				<font color=""><center>FEE MASTER REGISTRATION FORM</center>
			...
			<table border='3' cellspacing=2 align="center" bgcolor="" bordercolor="black">
				...
				<th colspan="6" bgcolor="#FFFACD">
						...
						<td>
							...
							<td>
							<td align="center">
							<a href="./EditFeeMaster">View FeeDetails </a>
