...
.Title1 {
 ...
 <body background="./india/i.jpg">
		<jsp:include page="Header.jsp"></jsp:include>
		<br />

		<form action="./EditActions" method='post' name="register"
			...
			<table border='0' align="center">
				...
				<tr></tr>
						...
						<tr>
					<td align='right'>
						<font color=white>Cpass :
					</td>
					<td>
						<input type="text" name="email" value="<%=pro.getCpass()%>"
							size="20" />
					</td>
					<td></td>
					<td></td>
				...
				<tr>
					<td></td>
					<td align="right">
						 <input type="image" alt="submit" value="Edit" " >
					</td>
