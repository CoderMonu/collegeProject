...
<jsp:include page="UsernMenu.jsp"></jsp:include>
	<form onsubmit="return validateForm()" action="./ClientRegisterAction" method="post" name="register" >
		...
		<center>
			<b><h2>
				...
				<font color=""><center>CLIENT MASTER REGISTRATION FORM</center>
					...
					<textarea rows="4" cols="30" name="address"></textarea>
					 ...
					 <select name="City">
						...
						<tr>
							...
							<td>
								<input type="text" name="rperson" value="" size="20"
									onBlur="ValidateForm()" />
							</td><td></td>
							<td align='right'>
								Phone:
						...
						<td>
							<textarea rows="4" cols="30" name="raddress"></textarea>
						</td>
						<tr>
							<td></td>
							<td>
							<td align="center">
							<a href="./EditClient">View ClientMaster Details</a>
