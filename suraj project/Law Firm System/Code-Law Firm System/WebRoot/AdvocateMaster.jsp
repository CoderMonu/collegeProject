...
<jsp:include page="UsernMenu.jsp"></jsp:include>
	<form onsubmit="return validateForm()" action="./AdvocateRegister" method="post" name="register" >
		...
		<center>
			<b><h2>
				...
				<font color=""><center>ADVOCATE MASTER REGISTRATION FORM</center>
			...
			<table border='3' cellspacing=2 align="center" bgcolor="" bordercolor="black">
				...
				<th colspan="6" bgcolor="#FFFACD">
					 ...
					 <select name="level">
							...
							<option value="Oppsite">Oppsite</option>
					...
					<textarea rows="4" cols="30" name="address"></textarea>
					 ...
					 <select name="city">
						...
						<tr>
							...
							<td>
							<td align="center">
							<a href="./EditAdvocate">View Advocate Details</a>
