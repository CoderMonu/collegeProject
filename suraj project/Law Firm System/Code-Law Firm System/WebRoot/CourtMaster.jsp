...
<jsp:include page="UsernMenu.jsp"></jsp:include>
	<form onsubmit="return validateForm()" action="./CourtRegisterAction" method="post" name="register" >
		...
		<center>
			<b><h2>
				...
				<font color=""><center>COURT MASTER REGISTRATION FORM</center>
			...
			<table border='3' cellspacing=2 align="center" bgcolor="" bordercolor="black">
				...
				<th colspan="6" bgcolor="#FFFACD">
					 ...
					 <select name="court">
							...
							<option value="LowerCourts">Lower Courts</option>
							<option value="TribunalsCourts">Tribunals Courts</option>
				 ...
				 <td></td>
					 ...
					 <select name="Cside">
							<option value="">--Select One--</option>
							<option value="OriginalSide">OriginalSide</option>
							<option value="AppellateSide">AppellateSide</option>
					...
					<textarea rows="4" cols="30" name="address"></textarea>
					 ...
					 <select name="city">
						...
						<tr>
							...
							<td>
							<td align="left">
							<a href="./EditCM">View CourtMaster Details</a>
