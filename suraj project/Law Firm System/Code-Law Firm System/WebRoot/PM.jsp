...
<jsp:include page="Adminmenu.jsp"></jsp:include>
	<form onsubmit="return validateForm()" action="./PMoneyAction" method="post" name="register" >
			...
			<table border='3' cellspacing=2 align="center" bgcolor="" bordercolor="black">
              ...
              <%
				...
				<th colspan="10" bgcolor="#FFFACD">
						...
						<td>
							<input type="text" name="recno" value="<%=rm.nextInt(888)%>" readonly="readonly"/>
						</td> 
						<td align='right'>
                           Date:
						</td>
						<td>
							...
							<a
						href="javascript:show_calendar('document.register.rdate', document.register.rdate.value);">
				...
				<td></td>
					...
					<font size="3" face="Verdana">
					 <select name="AmountType">
							...
							<td>
					<input type="text" name="cdno" size="30" value="<%=rm.nextInt(888888)%>">
					...
					<textarea rows="4" cols="30" name="note"></textarea>
						...
						<img src="<%=request.getContextPath()+"/images/cal.gif"%>" alt="a" width="18" height="18"
							...
							<td>
								<textarea rows="4" cols="30" name="words"></textarea>
							</td>
							</tr>
							<tr>
							<td align='right'>
