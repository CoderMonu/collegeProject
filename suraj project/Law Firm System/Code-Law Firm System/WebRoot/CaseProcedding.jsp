	...
	<body bgcolor="#ADD8E6">
		...
		<center>
			<b><h2>
				...
				<font color=""><center>CASE PROCEDING FORM</center>
				
				</h2> </b>
		</center>
		<form method='post' action="./CaseProceedingDetails" name="register">
					 ...
					 <input type="text" name="cno" value="" />
					  <td></td>
						 ...
						 <td align='right'>
                            ...
                            <td>						
							<input type="text" name="opposite" value="" />
					...
					<a
					  ...
					  <td></td>
                         <td align='right'>
                            ...
                            <td>						
							<textarea rows="4" cols="30" name="hds"></textarea>
