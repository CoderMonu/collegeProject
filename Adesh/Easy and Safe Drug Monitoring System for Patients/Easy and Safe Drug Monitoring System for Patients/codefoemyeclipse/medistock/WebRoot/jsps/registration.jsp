...
window.location.href='http://'+host+':'+port+'/PharmacyInformationSystem/CheckUserAction?userName='+userName+"&path=./registration.jsp";
;
	...
	<body>
		...
		<center>
			<h3>
				...
				<span class=subHead ><br /><font color="white">Registration Form</font> </span>
			</h3>
		</center>
		...
		<form action="./RegisterAction" method="post" name="register"
			...
			<table border='0' align="center" width=80% height="100%" bgcolor="">
    ...
    out.print(request.getParameter("userName")); %>"
				...
				<tr>
					...
					<td border="0" align="left" rowspan="5" colspan='2'>
						...
						<img alt="See Photo Here" id="previewField" src="images/"
					...
					<td width="276">
						<select name="loginType" onChange="cleartext()">
							...
							<option value="customer">
								<font size="3" face="Verdana">Customer</font>
							</option>
							<option value="dealer">
								<font size="3" face="Verdana">Dealer</font>
							</option>
							<option value="employee">
								<font size="3" face="Verdana">Employee</font>
							</option>
...
//You should create the validator only after the definition of the HTML form
  ...
  frmvalidator.addValidation("fax","numeric","  Fax numerics  only");
   ...
   frmvalidator.addValidation("country","req","Please enter your Country Name");
    ...
    frmvalidator.addValidation("pin","maxlen=6","Max length is 6 only");
  frmvalidator.addValidation("pin","numeric","  Pincode is numerics  only");
