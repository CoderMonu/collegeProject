			...
			<c:if test="${not empty medicalinfo}">
				<c:forEach var="medicalinfo" items="${medicalinfo}">
					<tr>
						...
						<td align='center'>
							<a
								href="./jsps/sellorder.jsp?productid=${medicalinfo.productid}&userid=${medicalinfo.userid}&avail=${medicalinfo.avail_quantity}&medicinename=${medicalinfo.medicinename}&price=${medicalinfo.price}">Sell</a>
						</td>
						<td align='center'>
