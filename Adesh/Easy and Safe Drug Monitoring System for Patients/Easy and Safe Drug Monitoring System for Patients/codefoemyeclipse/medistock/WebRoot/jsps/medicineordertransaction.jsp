...
function printpage() {
  ...
  <body onload="javascript:disableBackButton()" >
     ...
     <% int i=Integer.parseInt((request.getParameter("reqorder")));
         ...
         int k=i*j;
     %>
 <form action="<%=request.getContextPath()%>/MedicineOrderTransactionAction"  name="medicineorder" method="post" >
   ...
   <caption><h3>Paying Money </caption></br></br>
     ...
     <tr><td align="center"><input type="button" name="" value="Print" onclick="printpage()"></td><td align="center"><input type="submit" name="" value="Submit" onclick=" return Check();"></td></tr>
    </table>
 <br/><br/>
    </form>
