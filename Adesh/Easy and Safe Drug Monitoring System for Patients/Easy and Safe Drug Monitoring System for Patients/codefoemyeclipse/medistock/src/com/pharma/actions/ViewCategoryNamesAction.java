...
public class ViewCategoryNamesAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//System.out.println("Cname>>>>>>>>>" + categoryname);
		//if (request.getParameter("categoryname") != null) {
			try {
				...
				if (!opv.isEmpty()) {
					...
					path = UtilConstants._VIEW_CATEGORY_NAMES;
				} else if (opv.isEmpty()) {
					request.setAttribute("status",
							UtilConstants._NO_CATEGORY_NAMES);
					//request.setAttribute("categoryname", categoryname);
					request.setAttribute("medicinename", medicinename);
					path = UtilConstants._VIEW_ALL_CATEGORY_NAMES;
				...
				request.setAttribute("status",
						UtilConstants._VIEW_ALL_CATEGORY_NAMES);
				path = UtilConstants._VIEW_ALL_CATEGORY_NAMES;
			}
