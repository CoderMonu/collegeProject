...
public class DeleteCompanyAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			flag = new MedicalInfoMgrDelegate().deleteCompany(cid);

			if (flag) {
				request.setAttribute("status",
						UtilConstants._COMPANY_DELETE_SUCCESS);
				path = UtilConstants._STATUS;
			} else {
				request.setAttribute("status", UtilConstants._COMPANY_DELETE_FAIL);
				path = UtilConstants._STATUS;
			}
