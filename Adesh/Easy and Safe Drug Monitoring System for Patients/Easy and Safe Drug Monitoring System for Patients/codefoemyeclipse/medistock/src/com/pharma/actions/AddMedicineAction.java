...
public class AddMedicineAction extends HttpServlet {
	/**
	 * 
	 */
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			flag = new MedicalInfoMgrDelegate().addmedicine(mto);
			if (flag) {
				path = UtilConstants._STATUS;
				request.setAttribute("status",
						UtilConstants._MEDICINE_ADDED_SUCCESS);
			} else {
				path = UtilConstants._STATUS;
				request.setAttribute("status",
						UtilConstants._MEDICINE_ADDED_FAIL);
			}
		}
