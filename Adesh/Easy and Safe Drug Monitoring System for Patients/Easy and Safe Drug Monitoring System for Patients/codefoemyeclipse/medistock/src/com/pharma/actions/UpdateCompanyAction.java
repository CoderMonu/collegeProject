...
public class UpdateCompanyAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			try {
				...
				flag = new MedicalInfoMgrDelegate().updateCompany(mto);
			...
			if (flag) {
				request.setAttribute("status",
						UtilConstants._UPDATE__COMPANY_SUCCESS);
				path = UtilConstants._STATUS;
			} else {
				request.setAttribute("status",
						UtilConstants._UPDATE__COMPANY_FAIL);
				path = UtilConstants._STATUS;
			}
