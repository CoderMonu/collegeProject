...
public class UpdateCategoryAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			try {
				...
				flag = new MedicalInfoMgrDelegate().updateCategory(mto);
			...
			if (flag) {
				request.setAttribute("status",
						UtilConstants._UPDATE__CATEGORY_SUCCESS);
				path = UtilConstants._STATUS;
			} else {
				request.setAttribute("status",
						UtilConstants._UPDATE__CATEGORY_FAIL);
				path = UtilConstants._STATUS;
			}
