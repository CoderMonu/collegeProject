...
/**
 * This RecoverPasswordAction Class implements the recover the password in any
 * case the user can forget the password using the security question and proper
 * answer it will gain from database
 */
public class RecoverPasswordAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			password = new ProfileMgrDelegate().recoverPasswordByQuestion(rb);
